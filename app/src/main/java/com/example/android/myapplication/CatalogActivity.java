...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insertBook() {
        ...
        // and Letters Against War book attributes are the values.
        ContentValues values = new ContentValues();
        values.put(BookEntry.COLUMN_PRODUCT_NAME, "Tiziano Terzani - Letters Against War");
        values.put(BookEntry.COLUMN_PRICE, 10);
        values.put(BookEntry.COLUMN_QUANTITY, 3);
        values.put(BookEntry.COLUMN_SUPPLIER_NAME, "Frasier Crane");
        values.put(BookEntry.COLUMN_SUPPLIER_PHONE_NUMBER, 555555555);
